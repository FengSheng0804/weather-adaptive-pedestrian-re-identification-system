# Convert the re-parameterized convolutional weights back to standard convolutional weights
# 1. use backbone_train's DEANet to train the model
# 2. use reparam.py to convert the weights
# 3. use backbone's Backbone to build the model for inference
