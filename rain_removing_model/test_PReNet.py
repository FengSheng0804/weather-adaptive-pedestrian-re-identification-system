...
parser.add_argument("--save_path", type=str, default="rain_removing_model/results", help='path to save results')
...
def test():
    ...
    time_test = 0
    count = 0
    rainy_image_dir = os.path.join(opt.data_path, 'rainy_image')
    for img_name in os.listdir(rainy_image_dir):
        if is_image(img_name):
            img_path = os.path.join(rainy_image_dir, img_name)
